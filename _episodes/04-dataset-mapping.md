...
<img src="{{ page.root }}/fig/barcoding_cartoon.jpg){: .image-with-shadow }" alt="Conceptual model of a barcoding analysis" style="width: 800px;">
...
<img src="{{ page.root }}/fig/metabarcoding_cartoon.jpg){: .image-with-shadow }" alt="Conceptual model of a metabarcoding analysis" style="width: 800px;">
...
<img src="{{ page.root }}/fig/qPCR_cartoon.jpg){: .image-with-shadow }" alt="Conceptual model of a qPCR analysis" style="width: 800px;">
